...
public class Test {
    ...
    //    private static String driverPath="lib/geckodriver";
...
//        System.out.println(chapterToString(bookBaseUrl+testChapterID));
        //writeCookieToJson("123456");
        initialization();//初始化，已获得cookie，已获得config文件的Map，并检测了是否使用代理
        mainMenu();
//        writeTotal("7400669579342531646","");
//        System.out.println(getChapters("6982529841564224526"));
//        System.out.println(getAuthor("6982529841564224526"));
//        System.out.println(getStatus("6982529841564224526"));
//        System.out.println(getTitle("6982529841564224526"));
...
//            System.out.println("标签的数量"+elements.size());
            String result="";
...
//            System.out.println(strInterpreter(result, 0));
...
//            Random random=new Random();
//            int delay = random.nextInt(50, 151);
//            Thread.sleep(delay);    //线程等待50--150（随机）毫秒，以防止本地IP被服务器拉黑
        }
...
class cookieJsonStruct{
    //    private String novel_web_id="novel_web_id";
    private String novel_web_id;

    public cookieJsonStruct(String cookie) {
//        this.novel_web_id = novel_web_id;
        this.novel_web_id = cookie;
    }

    public String getNovel_web_id() {
        return novel_web_id;
    }
...
//    public configJsonStruct(String savePath, String encoding, String mail, String password, String smtp, int port) {
